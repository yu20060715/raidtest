...
:: Step 3: link with g++
C:\msys64\usr\bin\bash.exe --login -c "export PATH='/mingw64/bin:/usr/bin:/c/Windows/System32'; cd '/c/Users/Yu/Desktop/raidv3' && g++ -Wall -O2 build/*.o -o raidtest_winfsp.exe -L. -lwinfsp-x64 -lole32 -lshell32 -lshlwapi -lws2_32 -ladvapi32 -lntdll -lcomctl32 -lgdi32 -ldwmapi -ld3d11 -ldxgi -ld3dcompiler -static-libgcc -static-libstdc++ 2>&1"
if errorlevel 1 (
  echo Link FAILED
  pause
  exit /b 1
